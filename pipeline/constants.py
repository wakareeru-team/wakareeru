...
- 子车型：一些较大型号车型家族下的细分型号，注意不是番台。例如，kiha 40系列下有kiha 40, kiha 47, kiha 147等车型。这一项输出请不要带任何series等后缀，也不要加上运营商前缀例如JRF。直接输出子车型的名称，例如kiha 147，E231-1000等。罗马音写的表记请保持只有首字母大写，例如文件中可能的KiHa也写成Kiha。如果没有明确的子车型信息请留空，不要随意猜测，也不要直接写机车型号,也不要在这里写番台。
